# Contributing to Flight Job Script Service

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Job Script Service? Welcome! Please read this
...
You can help Flight Job Script Service by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-job-script-service/issues?state=open)
...
If you find a bug - behaviour of Flight Job Script Service code or documentation
...
[GitHub issue tracker for Flight Job Script Service](https://github.com/openflighthpc/flight-job-script-service/issues/new)
to report the issue.
...
We want to improve the quality of Flight Job Script Service and good bug reports are
...
Flight Job Script Service is Open Source and comes without warranty.
...
Flight Job Script Service in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Job Script Service and really improve it. The more
...
applied to Flight Job Script Service itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-job-script-service). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Job Script Service developers also have their regular
